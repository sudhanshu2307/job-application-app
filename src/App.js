    ...
    <div style={{ minHeight: "100vh", background: "#F9FAFB", position: "relative" }}>
      ...
      >
        ...
        <nav style={{ display: 'flex', gap: 50 }}>
          <button className="font-semibold text-gray-900 bg-white rounded-xl   py-2">Home</button>
          <button className="font-semibold text-gray-900 bg-white rounded-xl   py-2">Find Jobs</button>
          <button className="font-semibold text-gray-900 bg-white rounded-xl  py-2">Find Talents</button>
          <button className="font-semibold text-gray-900 bg-white rounded-xl   py-2">About us</button>
          <button className="font-semibold text-gray-900 bg-white rounded-xl   py-2">Testimonials</button>
        </nav>
        <button
